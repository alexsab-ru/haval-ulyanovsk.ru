...
cookiecook();
connectForms('https://alexsab.ru/lead/haval/ulyanovsk/', {
...
grecaptcha.ready(function() {
	grecaptcha.execute('6Lepfy4pAAAAAAGHFP655qNe6Bb_BcskklcxajC6', {action: 'haval_ulyanovsk'}).then(function(token) {
